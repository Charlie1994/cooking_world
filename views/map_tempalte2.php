            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="view-activity-tab">
                    ...
                    <ul class="activity-list">
                        <li><a id="ac_b"  href="#" value="12 Lambourn street">activity 1</a><p>10-11 9:50</p></li>
                ...
                <div id="menu1" class="tab-pane fade">
                    <label>Activity Name</label><input id='ac_na' class="form-control"/>
                    <label>NAME</label><input id='na' class="form-control"/>
                    <label>ADDRESS</label><input id="add" class="form-control"/>
                    <label>Contact Phone</label><input id='cp' class="form-control"/>
                    <br>
                    <button id='csubmit' class="btn btn-primary">Add</button>
                </div>
            </div>
        </div>
...
//    }
    ...
    function initAutocomplete() {
        ...
        google.maps.event.addListener(map, 'click', function(event){
            ...
            alert(latlng);
            document.getElementById("add").value=latlng;
        });
